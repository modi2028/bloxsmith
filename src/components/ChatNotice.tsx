...
export function ChatNotice({
  ...
  return (
    <div className="fade-up mb-2.5 rounded-2xl bg-gradient-to-r from-amber-500 via-rose-500 to-pink-500 p-px shadow-[0_18px_50px_-24px_rgba(244,63,94,0.8)]">
      <div className="flex items-start gap-3.5 rounded-[15px] bg-surface-raised px-4 py-3.5">
        <span className="mt-0.5 flex size-6 shrink-0 items-center justify-center rounded-full border border-rose-400/60 text-rose-300">
        ...
        <p className="min-w-0 flex-1 text-sm leading-relaxed text-rose-100">
          {message}
          {action && (
            <>
              {" "}
