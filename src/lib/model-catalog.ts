...
export const MODEL_CATALOG: CatalogModel[] = [
  ...
  // ---- Free tier -----------------------------------------------------------
  {
    ...
    description: "Fast and smart — the right default for most mechanics",
    tier: "balanced",
  ...
  },
  {
    ...
    description: "Quick edits and small tweaks at the lowest cost",
    tier: "fast",
  ...
  },
  {
    ...
    description: "Google's fast model for simple changes",
    tier: "fast",
...
export const PRO_PLAN = {
  ...
  monthlyCredits: 20,
  perks: [
    "Unlocks Claude Opus 4.8 and ChatGPT 5.5",
...
export const APP_SETTINGS_DEFAULTS: { key: string; value: unknown }[] = [
  ...
  { key: "default_model_id", value: "claude-sonnet-5" },
